...
String _REDIRECT_URI =
    'http://127.0.0.1:3030/Users/jasonhall/git/foursquare-dart/oauthWindow.html';
  ...
  e.on.click.add((_) {
    fsq.login(_REDIRECT_URI).then((__) {
      ...
      fsq.users.get().execute().then((userResp) {
        ...
        fsq.requestFactory.build('GET', 'updates/notifications').execute().then((notificationsResp) {
